...
[
  {
    "name": "Actor",
    "description": "You have advantage on Charisma (Deception) and Charisma (Performance) checks when trying to pass yourself off as a different person. You can mimic the speech of another person or the sounds made by other creatures.",
    "prerequisite": null
  },
  {
    "name": "Alert",
  ...
  {
    "name": "Athlete",
    "description": "When you are prone, standing up uses only 5 feet of your movement. Climbing doesn't halve your speed. You can make a running long jump or a running high jump after moving only 5 feet on foot, rather than 10 feet.",
    "prerequisite": null
  },
  {
    "name": "Charger",
  ...
  {
    "name": "Durable",
    "description": "When you roll a Hit Die to regain hit points, the minimum number of hit points you regain from the roll equals twice your Constitution modifier (minimum of 2).",
    "prerequisite": "Constitution 13 or higher"
  },
  {
    "name": "Elemental Adept",
    "description": "Choose one of the following damage types: acid, cold, fire, lightning, or thunder. Spells you cast ignore resistance to damage of the chosen type. In addition, when you roll damage for a spell you cast that deals damage of that type, you can treat any 1 on a damage die as a 2.",
    "prerequisite": "The ability to cast at least one spell"
  },
  {
    "name": "Grappler",
    "description": "You have advantage on attack rolls against a creature you are grappling. You can use your action to try to pin a creature grappled by you. To do so, make another grapple check. If you succeed, you and the creature are both restrained until the grapple ends.",
  ...
  },
  {
    ...
    "description": "While you are wearing heavy armor, bludgeoning, piercing, and slashing damage that you take from nonmagical attacks is reduced by 3.",
  ...
  {
    "name": "Keen Mind",
    "description": "You always know which way is north. You always know the number of hours left before the next sunrise or sunset. You can accurately recall anything you have seen or heard within the past month.",
    "prerequisite": null
  },
  {
    "name": "Lightly Armored",
    "description": "You gain proficiency with light armor.",
    "prerequisite": null
  },
  {
    "name": "Linguist",
    "description": "You learn three new languages of your choice. You can ably create written ciphers. Others can't decipher a code you create unless you teach them, they succeed on an Intelligence check (DC equal to your Intelligence score + your proficiency bonus), or they use magic to decipher it.",
    "prerequisite": null
  },
  {
    "name": "Lucky",
  ...
  },
  {
    ...
    "description": "Wearing medium armor doesn't impose disadvantage on your Dexterity (Stealth) checks. When you wear medium armor, you can add 3, rather than 2, to your AC if your Dexterity is 16 or higher.",
    "prerequisite": "Proficiency with medium armor"
  },
  {
    "name": "Mobile",
  ...
  },
  {
    ...
    "description": "Increase your Strength or Dexterity score by 1, to a maximum of 20. You gain proficiency with medium armor and shields.",
  ...
  {
    "name": "Ritual Caster",
    "description": "You have a spellbook containing two 1st-level spells of your choice. Choose one of the following classes: bard, cleric, druid, sorcerer, warlock, or wizard. You must choose your spells from that class's spell list, and the spells you choose must have the ritual tag. The class you choose also determines your spellcasting ability for these spells: Charisma for bard, sorcerer, or warlock; Wisdom for cleric or druid; or Intelligence for wizard.",
  ...
  {
    "name": "Shield Master",
    "description": "If you take the Attack action on your turn, you can use a bonus action to try to shove a creature within 5 feet of you with your shield. If you aren't incapacitated, you can add your shield's AC bonus to any Dexterity saving throw you make against a spell or other harmful effect that targets only you. If you are subjected to an effect that allows you to make a Dexterity saving throw to take only half damage, you can use your reaction to take no damage if you succeed on the saving throw, interposing your shield between yourself and the source of the effect.",
    "prerequisite": null
  },
  {
    "name": "Skilled",
  ...
  {
    "name": "Tavern Brawler",
    "description": "You are proficient with improvised weapons. Your unarmed strike uses a d4 for damage. When you hit a creature with an unarmed strike or an improvised weapon on your turn, you can use a bonus action to attempt to grapple the target.",
    "prerequisite": null
  },
  {
    "name": "Tough",
  ...
  {
    "name": "Weapon Master",
    "description": "You gain proficiency with four weapons of your choice. Each one must be a simple or a martial weapon.",
    "prerequisite": null
  }
]
"""

def load_feats(apps, schema_editor):
    Feat = apps.get_model('base', 'Feat')

    data = json.loads(FEATS_JSON)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('base', '0019_auto_20260126_2125'), 
    ]

    operations = [
        migrations.RunPython(load_feats),
    ]